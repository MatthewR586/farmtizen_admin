...
function Tasks() {
  ...
  const handleSaveNewTask = () => {
    console.log("object")
    if (taskBonus == "" || taskName == "" || taskLink == "" || taskType === undefined || bonusType == undefined) {
      notification.info({
        message: "Info",
        ...
        return (
          <Space size="small">
            <div style={{ whiteSpace: "wrap", width: "100px" }}>
              {`${bonus} ${record.bonus_type ? 'xp' : 'token'}`}
            </div>
          </Space>
        );
      },
                ...
                <Row style={{ marginBottom: "20px" }} gutter={50}>
                  ...
                  <Col span={4}>
                    ...
                    <Select
                      ...
                      options={defaultBonusTypeOptions}
                      size="large"

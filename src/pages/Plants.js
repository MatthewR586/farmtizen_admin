...
function Plants() {
  ...
  const handleSaveNewTask = () => {
    ...
    axios
      .post(`${backend_api}/plants`, formData, {
        headers: {
        ...
        return (
          <div>
            <Button
              ...
              onClick={(e) => handleEditClick(record)}
            >
              Edit
            </Button>
          </div>
